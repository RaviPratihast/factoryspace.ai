...
//     excerpt: 'factoryspace.ai closes $200M to scale manufacturing.',
//     image: null,
//     featured: false,
//   },
// ];
...
//     <section
//       id="news"
//       className="news-preview-section py-[200px] max-[991px]:py-[160px] max-[767px]:py-[80px]"
//       aria-labelledby="news-preview-title"
//     >
//       <div className="news-preview-container container-default mx-auto px-6">
//         <div className="news-preview-header mb-16 animate-on-scroll opacity-0 translate-y-[50px]">
//           <h2
//             id="news-preview-title"
//             className="news-preview-title text-[48px] max-[991px]:text-[36px] max-[767px]:text-[32px] font-medium leading-[1.25em] text-white"
//           >
//             Our latest news
//           </h2>
//         </div>

//         <div className="news-preview-grid grid grid-cols-1 gap-7 lg:grid-cols-[1.66fr_1fr]">
//           <Link
//             href="#"
//             className="news-preview-featured group relative overflow-hidden rounded-[32px] bg-[#121418] block transition-transform duration-300 hover:scale-[0.99]"
//           >
...
//           <div className="news-preview-list flex flex-col gap-7">
//             {list.map((article) => (
//               <Link
//                 key={article.title}
//                 href="#"
//                 className="news-preview-list-item group flex flex-col justify-between rounded-[32px] bg-[#121418] border border-[#121418] p-8 transition-transform duration-300 hover:scale-[0.99]"
//               >
