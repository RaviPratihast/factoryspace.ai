...
//     <section
//       id="specs"
//       className="product-spotlight-section relative overflow-hidden py-[200px] max-[991px]:py-[160px] max-[767px]:py-[80px]"
//       aria-labelledby="product-spotlight-title"
//     >
//       <div className="product-spotlight-background pointer-events-none absolute inset-0 -z-10">
//         <Image
...
//       <div className="product-spotlight-container container-default mx-auto px-6">
//         <h2
//           id="product-spotlight-title"
//           className="product-spotlight-title mb-16 text-[48px] max-[991px]:text-[36px] max-[767px]:text-[32px] font-medium leading-[1.25em] text-white animate-on-scroll opacity-0 translate-y-[50px]"
//         >
//           Introducing OmniBot Gen 2
//         </h2>

//         <div className="product-spotlight-specs flex flex-col gap-0">
//           {specs.map((spec) => (
//             <div
//               key={spec.label}
//               className="product-spotlight-spec-row pointer-line-wrapper relative flex items-center justify-between gap-4 border-t border-[#3b3e45] py-6 animate-on-scroll opacity-0 translate-y-[50px]"
//             >
